package de.larmic.butterfaces.component.showcase.templatecombobox;

import de.larmic.butterfaces.component.html.templatecombobox.ComboBoxDataProvider;
...
public class TemplateComboBoxShowCase extends AbstractInputShowcase implements Serializable {
    ...
    public void buildCodeExamples(final List<AbstractCodeExample> codeExamples) {
        ...
        xhtmlCodeExample.appendInnerContent("        <b:templateComboBox id=\"input\"");
    ...
    public ComboBoxDataProvider getComboBoxDataProvider() {
        return new ComboBoxDataProvider() {
            @Override
            public List getComboBoxEntries(String queryString) {
                return Arrays.asList(
                        new MyComboBoxData("https://avatars1.githubusercontent.com/u/275410?v=3&s=460", queryString + " 1", "first one"),
                        new MyComboBoxData("https://avatars1.githubusercontent.com/u/275410?v=3&s=460", queryString + " 2", "another one")
                );
            }
        };
    }

    public static class MyComboBoxData {
        ...
        public MyComboBoxData(String imgUrl, String displayValue, String additionalInfo) {
            this.imgUrl = imgUrl;
